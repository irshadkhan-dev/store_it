...
const getValidatedRouterParams = createWrapperFunction(
  getValidatedRouterParams$1
);
...
const useBase = createWrapperFunction(useBase$1);
...
const sealSession = createWrapperFunction(sealSession$1);
