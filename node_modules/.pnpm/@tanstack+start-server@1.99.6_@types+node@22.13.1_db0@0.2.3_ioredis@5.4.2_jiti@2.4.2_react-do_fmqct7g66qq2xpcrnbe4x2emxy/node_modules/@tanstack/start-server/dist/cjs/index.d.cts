...
type WrapFunction<TFn extends (...args: Array<any>) => any> = (...args: Parameters<TFn> extends [H3Event, ...infer TArgs] ? TArgs | Parameters<TFn> : Parameters<TFn>) => ReturnType<TFn>;
export declare const readRawBody: WrapFunction<typeof _readRawBody>;
export declare const readBody: WrapFunction<typeof _readBody>;
export declare const getQuery: WrapFunction<typeof _getQuery>;
...
export declare const getValidatedQuery: WrapFunction<typeof _getValidatedQuery>;
...
export declare const getValidatedRouterParams: WrapFunction<typeof _getValidatedRouterParams>;
...
export declare const setResponseHeader: WrapFunction<typeof _setResponseHeader>;
export declare const appendResponseHeaders: WrapFunction<typeof _appendResponseHeaders>;
export declare const appendResponseHeader: WrapFunction<typeof _appendResponseHeader>;
...
export declare const fetchWithEvent: WrapFunction<typeof _fetchWithEvent>;
...
export declare const useBase: WrapFunction<typeof _useBase>;
export declare const useSession: WrapFunction<typeof _useSession>;
export declare const getSession: WrapFunction<typeof _getSession>;
export declare const updateSession: WrapFunction<typeof _updateSession>;
export declare const sealSession: WrapFunction<typeof _sealSession>;
...
export declare const appendHeader: WrapFunction<typeof _appendResponseHeader>;
export declare const appendHeaders: WrapFunction<typeof _appendResponseHeaders>;
export declare const setHeader: WrapFunction<typeof _setResponseHeader>;
...
export declare const readValidatedBody: WrapFunction<typeof _readValidatedBody>;
...
export declare function getEvent(): any;
